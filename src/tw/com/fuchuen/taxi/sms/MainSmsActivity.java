package tw.com.fuchuen.taxi.sms;

import java.util.Calendar;

import tw.com.fuchuen.taxi.R;
import tw.com.fuchuen.taxi.email.MainEmailActivity.TurnLightHandler;
...
public class MainSmsActivity extends Activity{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.main_sms_layout);
	...
	private void setupButtons() {
    	...
    	smsBtn.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				...
				intent.putExtra("sms_body", combineString());
